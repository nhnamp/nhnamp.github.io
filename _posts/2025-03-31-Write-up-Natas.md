...
Go to the source of the image by extending the link of the website --> [http://natas2.natas.labs.overthewire.org/files](http://natas2.natas.labs.overthewire.org/files)
...
Starting analyzing this website's execution flow.
